...
public class Trainer extends Human {
    ...
    public boolean addClass(Finals.classNames name, int hour, LocalDate date) {
        GymClass newClass = new GymClass();
        newClass.setName(name).setStartHour(hour).setFinishedHour().setDate(date).setTrainerId(this).setImageRes().setTeacherName(this.getName());
        if (isTrainerAvailable(newClass)) {
    ...
    public boolean isTrainerAvailable(GymClass newClass) {
    ...
    public ArrayList<Integer> showFreeHours(LocalDate date) {
        ...
        for (GymClass thisClass : getGymClasses().values()) {
