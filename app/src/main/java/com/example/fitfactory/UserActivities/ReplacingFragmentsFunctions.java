...
public class ReplacingFragmentsFunctions {
    ...
    public void changeToUserHomeFragment(ImageView main_BTN_notification, ImageView main_BTN_contact
    ...
    public void changeToUserCalendarFragment(ImageView main_BTN_notification, ImageView main_BTN_contact, ImageView main_BTN_calendar, ImageView main_BTN_home, LinearLayout main_LL_calendar) {
        main_BTN_notification.setImageResource(R.drawable.notification);
        main_BTN_contact.setImageResource(R.drawable.call_us);
    ...
    public void changeToUserFriendsFragment(ImageView main_BTN_notification, ImageView main_BTN_contact
            , ImageView main_BTN_calendar, ImageView main_BTN_home, LinearLayout main_LL_friends) {
        main_BTN_contact.setImageResource(R.drawable.call_us);
        main_BTN_notification.setImageResource(R.drawable.notification);
        main_BTN_calendar.setImageResource(R.drawable.calender);
        main_BTN_home.setImageResource(R.drawable.home);
    ...
    public void changeToUserNotificationsFragment(ImageView main_BTN_notification, ImageView main_BTN_contact, ImageView main_BTN_calendar, ImageView main_BTN_home, LinearLayout main_LL_notification) {
        main_BTN_contact.setImageResource(R.drawable.call_us);
        main_BTN_calendar.setImageResource(R.drawable.calender);
        main_BTN_home.setImageResource(R.drawable.home);
    ...
    public void changeToUserContactFragment(ImageView main_BTN_notification, ImageView main_BTN_contact,ImageView main_BTN_calendar, ImageView main_BTN_home, LinearLayout main_LL_contact) {
        main_BTN_notification.setImageResource(R.drawable.notification);
        main_BTN_calendar.setImageResource(R.drawable.calender);
        main_BTN_home.setImageResource(R.drawable.home);
    ...
    public void changeToTrainerHomeFragment(ImageView trainer_BTN_home, ImageView trainer_BTN_add, ImageView
            trainer_BTN_change, LinearLayout trainer_LL_home) {
    ...
    public void changeToTrainerChangeClassFragment(ImageView trainer_BTN_home, ImageView trainer_BTN_add, ImageView
            trainer_BTN_change, LinearLayout trainer_LL_change) {
    ...
    public void changeToTrainerAddClassFragment(ImageView trainer_BTN_home, ImageView trainer_BTN_add, ImageView
            trainer_BTN_change, LinearLayout trainer_LL_addClass) {
        trainer_BTN_home.setImageResource(R.drawable.home);
        trainer_BTN_change.setImageResource(R.drawable.change_icon);
